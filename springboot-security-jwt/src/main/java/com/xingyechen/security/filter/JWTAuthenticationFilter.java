package com.xingyechen.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.xingyechen.security.model.JwtUser;
import com.xingyechen.security.model.LoginUser;
import com.xingyechen.security.utils.JwtTokenUtils;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public JWTAuthenticationFilter(AuthenticationManager authenticationManager) {
        ...
        //UsernamePasswordAuthenticationFilter：默认登录接口/login,这里自定义登录接口/auth/login
